...
**규칙 2 — 약재 목록 (상품 정보 없음)**
효능·성질·귀경·증상·제형 등 지식 정보 결과에서 약재를 나열할 때는 글머리 기호 목록을 사용하세요.
상품·가격·유통 정보가 함께 있는 경우에는 규칙 3의 herb-card 형식을 사용하세요 (표 사용 금지).

**규칙 3 — 약재 상품 카드 (herb-card)**
제조사·가격·포장 등 상품/유통 정보를 표시할 때는 표 대신 herb-card 형식을 사용하세요.
약재 1개 = herb-card 블록 1개.
